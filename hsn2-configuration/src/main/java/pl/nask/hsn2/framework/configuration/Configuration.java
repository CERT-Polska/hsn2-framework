 ...
 *
 *
 * According to the task #4010: BA: FUC-1.1 Reading configuration file the following configuration is needed:
 * 1 Logging
 * 1.1 Log filename
 * 1.2 Debugging level
 * 2 Workflow packages configuration
 * 2.1 Workflow packages filenames
 * 3 Bus configuration
 * 3.1 Connectivity
 * 3.1.1 Port number
 * 4 CLI configuration
 ...
 * (not required? - because of broadcast messages)
 * 6 Limits
 * 6.1 Maximum number of jobs processed by the framework
 * 6.2 Maximum number of URLs processed by the framework (optional)
 *
...
public class Configuration {
    ...
    Configuration(
            org.apache.commons.configuration.Configuration defaultConfig,
            org.apache.commons.configuration.Configuration userConfig) {
    ...
    public String[] getAMQPObjectStoreQueueNames() {
        return new String[] {
                getAMQPObjectStoreQueueLow(),
                getAMQPObjectStoreQueueHigh()
        };
    }
}
